(function() {
    ...
    style.innerHTML = `
        ...
        .nav-list-recruit li { margin: 30px 0; opacity: 0; transform: translateY(30px); transition: 0.6s cubic-bezier(0.4, 0, 0.2, 1); }
    ...
    const items = [
        ...
        { name: "Payment", sub: "決済ガイド（ギフトカード）", link: "https://studio-zen-node.github.io/payment.html" }
    ];
